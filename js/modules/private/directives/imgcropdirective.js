...
{
    App.register.directive("imageCropper",function($document,$window, $rootScope)
    {
		return {
			scope: {
				image: "=",
				...
				var ImageCropper = (function () {
					...
					ImageCropper.prototype.draw = function (ctx) {
						...
						if (this.srcImage) {
							...
							// var aspectRatioObj = {};
							// aspectRatioObj.height = bounds.getHeight();
							// aspectRatioObj.width = bounds.getWidth();
							$rootScope.cw = bounds.getWidth();
							$rootScope.ch = bounds.getHeight();
    ...
    App.register.directive("imgCropperFileread",function($timeout, $rootScope)
    {
		return {
			scope: {
				image: "="
